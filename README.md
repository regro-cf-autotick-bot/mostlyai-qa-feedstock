...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mostlyai-qa-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mostlyai-qa-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add mostlyai-qa
# for installing globally
pixi global install mostlyai-qa
```
...
It is possible to list all of the versions of `mostlyai-qa` available on your platform:
...
```
pixi search mostlyai-qa --channel conda-forge
```
